...
<body>
    ...
    <div class="d-inline float-right mr-5">
      <button class="btn btn-link pr-2"><a class="text-success" href="tablefunctions/robotics/insert-members-robotics.php">Insert</a></button>
      <button class="btn btn-link pr-2"><a class="text-primary" href="tablefunctions/robotics/update-members-robotics.php">Update</a></button>
      <button class="btn btn-link pr-2"><a class="text-danger" href="tablefunctions/robotics/delete-members-robotics.php">Delete</a></button>
    </div>
