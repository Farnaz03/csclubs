...
if(isset($_POST['btn-save']))
{
 ...
 $sql_query = "INSERT INTO aremembers (CID,SID,Role) VALUES('$name')";
  ...
  <div class="col-3 col-md-4">
    <form method="post">
      <table class="table" align="center">
        <thead>
          <h2>Insert into: Interest Table</h2>
        </thead>
      <tr>
        <td align="center">
          <input class="form-control" type="text" name="Name" placeholder="Interest Name" required />
        </td>
      </tr>
      <tr>
        <td align="center">
