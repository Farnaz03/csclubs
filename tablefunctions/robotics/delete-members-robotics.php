...
<body>
    ...
    <div class="d-inline float-right mr-5">
      <button class="btn btn-link pr-2 text-success"<a href="#">Insert</a></button>
      <button class="btn btn-link pr-2 text-primary"<a href="#">Update</a></button>
      <button class="btn btn-link pr-2 text-danger"<a href="#">Delete</a></button>
    </div>
