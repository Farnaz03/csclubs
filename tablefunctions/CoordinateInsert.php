...
if(isset($_POST['btn-save']))
{
 ...
 $sql_query = "INSERT INTO coordinate (CID,LID,Role) VALUES('$cid','$lid','$role')";
  ...
  <div class="col-3 col-md-4">
    <form method="post">
      <table class="table" align="center">
        <thead>
          <h2>Insert into: Coordinate Relationship Table</h2>
        </thead>
      <tr>
        <td align="center">
          <input class="form-control" type="text" name="CID" placeholder="Club ID" required />
        </td>
      </tr>
      <tr>
     <td align="center">
          <input class="form-control" type="text" name="LID" placeholder="Lecturer ID" required />
        </td>
      </tr>
      <tr>
        <td align="center">
