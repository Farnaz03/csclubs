...
// $email = $_POST['Email'];
 ...
 $sql_query = "INSERT INTO have (IID,SID) VALUES('$iid','$sid')";
  ...
  <div class="col-3 col-md-4">
    <form method="post">
      <table class="table" align="center">
        <thead>
          <h2>Insert into: Have Relationship Table</h2>
        </thead>
      <tr>
        <td align="center">
          <input class="form-control" type="text" name="IID" placeholder="Interest ID" required />
        </td>
      </tr>
      <tr>
     <td align="center">
